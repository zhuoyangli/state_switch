...
expName = 'ses-001_task-stories'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/gio/projects/SwitchCode/ses-001_task-stories/ses-001_task-stories.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    story_loop = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('ses-001_task-stories.xlsx'),
